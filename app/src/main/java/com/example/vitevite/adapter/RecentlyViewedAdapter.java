package com.example.vitevite.adapter;
...
import com.example.vitevite.ProductDetails;
import com.example.vitevite.R;
    ...
    public void onBindViewHolder(@NonNull RecentlyViewedViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.putExtra("name", recentlyViewedList.get(holder.getAdapterPosition()).getName());
                i.putExtra("image", recentlyViewedList.get(holder.getAdapterPosition()).getBigimageurl());
                i.putExtra("price",recentlyViewedList.get(holder.getAdapterPosition()).getPrice());
                i.putExtra("desc",recentlyViewedList.get(holder.getAdapterPosition()).getDescription());
                i.putExtra("qty",recentlyViewedList.get(holder.getAdapterPosition()).getQuantity());
                i.putExtra("unit",recentlyViewedList.get(holder.getAdapterPosition()).getUnit());
