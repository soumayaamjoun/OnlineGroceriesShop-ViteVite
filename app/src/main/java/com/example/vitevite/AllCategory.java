...
import com.example.vitevite.adapter.AllCategoryAdapter;
import com.example.vitevite.model.AllCategoryModel;
...
public class AllCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allCategoryModelList.add(new AllCategoryModel(9, R.drawable.parapharmacie2));
